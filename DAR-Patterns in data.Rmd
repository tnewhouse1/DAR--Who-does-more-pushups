...
The hypothesis is cannot be rejected because the P-value is indicating 1.73 which is above the p-value of 0.05 percent; so therefore, the hypothesis cannot not be rejected because it does show a relationship between weight and position. 
